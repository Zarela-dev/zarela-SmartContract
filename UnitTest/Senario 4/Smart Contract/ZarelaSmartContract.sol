...
contract ZarelaSmartContract is ERC20 {
    ...
    constructor(address _clock) {
        ...
        clock = IClock(_clock);
        countDown24Hours = clock.currentTime();
    }
    ...
    uint public countDown24Hours; // Starting 24 hours Timer By Block Timestamp (From Deploy Zarela)
    uint public dayCounterOf20Months; // Day Counter Of 20 Months (590 days  =  18 months )
    ...
    struct OrderData {
        ...
        bool[] whoGainedReward; // Array Of Gained Reward addresses
        ...
        notNull(_laboratoryAddress)
    {
        ...
        if (isZarelaEnd != true) {
            ...
            if (clock.currentTime() < countDown24Hours + 24 hours) {
                ...
                if (dayCounterOf20Months >= 589) { //18 month
